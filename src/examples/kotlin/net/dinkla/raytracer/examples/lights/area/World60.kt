...
object World60 : WorldDefinition {
    ...
    private val sampler1 = Sampler(MultiJittered, 2500, 100).apply {
    ...
    override fun world(): World = Builder.build {
        ...
        val r1 = RectangleLight(p0= p(9.5, 20.0, -0.5), a= v(1, 0, 0), b= v(0, 0, 1), sampler= sampler1).apply {
            material= world.materials["emissive"]
        }
        val r2 = RectangleLight(p0= p(26.5, 20.0, -3.5), a= v(7, 0, 0), b= v(0, 0, 7), sampler= sampler1).apply {
            material= world.materials["emissive"]
        }
