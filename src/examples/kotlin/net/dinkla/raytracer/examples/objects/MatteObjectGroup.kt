...
/**
 * A box, two spheres and a cylinder, all matte, on a plane and placed via instances. The reflective counterpart is
 * ReflectiveObjectGroup. Formerly World30.kt.
 */
object MatteObjectGroup : WorldDefinition {
    override val id: String = "MatteObjectGroup.kt"
