...
public class SparseGrid extends Grid {
    ...
    public void initialize() {
        ...
        for (GeometricObject object : objects) {
            ...
            final int ixmin = (int) MathUtils.clamp((objBbox.getP().getX() - bbox.getP().getX()) * nx / wx, 0, nx - 1);
            final int iymin = (int) MathUtils.clamp((objBbox.getP().getY() - bbox.getP().getY()) * ny / wy, 0, ny - 1);
            final int izmin = (int) MathUtils.clamp((objBbox.getP().getZ() - bbox.getP().getZ()) * nz / wz, 0, nz - 1);

            final int ixmax = (int) MathUtils.clamp((objBbox.getQ().getX() - bbox.getP().getX()) * nx / wx, 0, nx - 1);
            final int iymax = (int) MathUtils.clamp((objBbox.getQ().getY() - bbox.getP().getY()) * ny / wy, 0, ny - 1);
            final int izmax = (int) MathUtils.clamp((objBbox.getQ().getZ() - bbox.getP().getZ()) * nz / wz, 0, nz - 1);
