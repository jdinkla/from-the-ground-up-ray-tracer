...
builder.world(id: "World64") {
    ...
    objects {
        ...
        beveledBox(p0: p(0.25, 0, 0.25), p1: p(0.75, 0.75, 0.75), rb: 0.01, material: "Green Yellow", wireFrame: true)
        beveledBox(p0: p(1.25, 0, 1.25), p1: p(1.5, 0.5, 2), rb: 0.01, material: "Light Salmon", wireFrame: true)
//TODO: Bug        beveledBox(p0: p(0, 0, 1.5), p1: p(0.2, 0.25, 2.2), rb: 0.1, material: "Pink", wireFrame: true)
        beveledBox(p0: p(0.85, 0, 1.5), p1: p(1.05, 0.25, 2.2), rb: 0.01, material: "Pink", wireFrame: true)
        beveledBox(p0: p(-0.1, 0, 1), p1: p(0.3, 0.45, 2.2), rb: 0.01, material: "Gold1", wireFrame: true)
    }
