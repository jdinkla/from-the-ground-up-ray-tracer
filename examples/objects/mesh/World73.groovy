...
Grid ply3 = builder.ply(file: "${path}/horse/horse2K.ply", multiplier: 2.0, smooth: true)
Grid ply4 = builder.ply(file: "${path}/happy/happy_recon/happy_vrip_res4.ply", multiplier: 2.0, smooth: true)
...
//    viewPlane(resolution: Resolution.RESOLUTION_480, maxDepth: 2, numSamples: 4)
    ...
    camera(d: 1000, eye: p(0, 1, 3), lookAt: p(1.3, 0, 0), numThreads: 64)
...
//        instance(object: ply3, material: "orange") {
//            scale(v(1, 1, 1))
//            rotateY(-5)
//            translate(v(2, 0, 0))
//        }

        instance(object: ply4, material: "orange") {
            scale(v(3, 3, 3))
            translate(v(1, 0, 1))
        }
