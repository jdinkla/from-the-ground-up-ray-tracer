...
builder.world(id: "World55") {

    viewPlane(resolution: Resolution.RESOLUTION_480, numSamples: 2, maxDepth: 2,
        sampler: sampler)

    camera(d: 1000, eye: p(8, 1, 7), lookAt: p(11.2, 1, 0), numThreads: 8 )
