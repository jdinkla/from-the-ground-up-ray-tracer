...
//        rectangle(p0: p(2, 0, -10), a: v(0, 0, 10), b: v(0, 10, 0), material: "gray")
        r1 = rectangleLight(p0: p(9.5, 20, -0.5), a: v(1, 0, 0), b: v(0, 0, 1), sampler: sampler1, material: "emissive")
        r2 = rectangleLight(p0: p(26.5, 20, -3.5), a: v(7, 0, 0), b: v(0, 0, 7), sampler: sampler1, material: "emissive")
    }
